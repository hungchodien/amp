...
<script id="amp-access" type="application/json">
  {
    "authorization": "<%host%>/json/authorization.json?rid=READER_ID&url=CANONICAL_URL&ref=DOCUMENT_REFERRER&_=RANDOM",
    "noPingback": true,
    "login": "<%host%>/json/authorization.json?rid=READER_ID&url=CANONICAL_URL",
...
<amp-state id="shirts" [src]="'/shirts/sizesAndPrices?option_color=' + arg_select.option_color">
    <script type="application/json">
            {
                "1001": {
                    "color": "black",
...
<div id="container">
    ...
    <amp-carousel type="slides" layout="fixed-height" height=250 id="carousel"
                  on="slideChange:AMP.setState({selected_hungtt: {slide: event.index}})" autoplay delay="2000" loop>
        <!-- TODO: "Changing images in amp-carousel" -->
        <amp-img width=200 height=250 src="./shirts/black.jpg" [src]="shirts[arg_select.option_color].image"></amp-img>
        <amp-img width=300 height=375 src="./shirts/black.jpg" [src]="shirts[arg_select.option_color].image"></amp-img>
        <amp-img width=400 height=500 src="./shirts/black.jpg" [src]="shirts[arg_select.option_color].image"></amp-img>
    </amp-carousel>

    <!-- TODO: "Add a slide indicator" -->
    <p class="dots">
        <span [class]="selected_hungtt.slide == 0 ? 'current' : ''" class="current"></span>
        <span [class]="selected_hungtt.slide == 1 ? 'current' : ''"></span>
        <span [class]="selected_hungtt.slide == 2 ? 'current' : ''"></span>
    </p>
    ...
    <form method="post" action-xhr="/shirts/addToCart" target="_top">
        ...
        -->
            <amp-selector name="color" on="select:AMP.setState({arg_select : {option_color: event.targetOption}})" >
                <table>
                    <tr>
        ...
        <div class="options price">
            <h6>PRICE :
                <span [text]="shirts[arg_select.option_color].sizes[selectedSize] || '---'">---</span>
            </h6>
        </div>
        ...
        <div class="options sizes">
            ...
            <amp-selector name="size" on="select:AMP.setState({selectedSize: event.targetOption})">
                <table>
                    <tr>
                        <td [class]="shirts[arg_select.option_color].sizes['XS'] ? '' : 'unavailable'">
                            <div option="XS">XS</div>
                        </td>
                        <td [class]="shirts[arg_select.option_color].sizes['S'] ? '' : 'unavailable'">
                            <div option="S">S</div>
                        </td>
                        <td class="unavailable"
                            [class]="shirts[arg_select.option_color].sizes['M'] ? '' : 'unavailable'">
                            <div option="M">M</div>
                        </td>
                        <td class="unavailable"
                            [class]="shirts[arg_select.option_color].sizes['L'] ? '' : 'unavailable'">
                            <div option="L">L</div>
                        </td>
                        <td class="unavailable"
                            [class]="shirts[arg_select.option_color].sizes['XL'] ? '' : 'unavailable'">
        ...
        <div class="options purchase">
            ...
            <input type="submit" value="ADD TO CART" disabled
                   ...
                   [disabled]="!selectedSize || !shirts[arg_select.option_color].sizes[selectedSize]">
        </div>
